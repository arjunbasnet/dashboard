...
class UserBehaviorChart extends React.Component {
  data = {
  ...
  render(){
    ...
    <div className="card ">
      ...
      <div className="content">
        <Chart data={this.data} options={this.options} responsiveOptions={this.responsiveOptions} type="Bar" className="ct-chart" />
